...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/faizalsuhel874742/MLOps-Capstone-Project.mlflow",
    "dagshub_repo_owner": "faizalsuhel874742",
            ...
            for vec_name, vectorizer in VECTORIZERS.items():
                with mlflow.start_run(run_name=f"{algo_name} with {vec_name}", nested=True) as child_run:
                    try:
                        ...
                        # Log model (DagsHub-compatible way)
                        model_dir = f"models/{algo_name}_{vec_name}"
